...
export default function CardKontenConstellations({
  ...
  return (
    <>
      <div className="relative p-1 bg-gradient-to-tr from-blue-900 via-blue-800 to-blue-700 rounded-lg z-10 shadow-md cursor-pointer mb-6 transition ease-in-out hover:-translate-y-1 duration-300">
